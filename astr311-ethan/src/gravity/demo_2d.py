...
def main() -> None:
    ...
    p.add_argument("--r-min", type=float, default=0.5, dest="r_min", help="Disk inner radius (disk IC)")
    p.add_argument("--r-max", type=float, default=2.0, dest="r_max", help="Disk/cloud outer radius")
